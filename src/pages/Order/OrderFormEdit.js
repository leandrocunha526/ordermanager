...
const OrderEdit = (props) => {
    ...
    const onSubmit = (data) => {
        api.put(`/api/orders/edit/${id}`, data)
            .then(() => {
                ...
                <Form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    {errors.description &&
                        errors.description.type === "required" && (
                            <span>Descrição é um campo obrigatório</span>
                        )}
                    ...
                    {errors.status && errors.status.type === "required" && (
                        <span>Estado é um campo obrigatório</span>
                    )}
                    ...
                    />
                    {errors.local && errors.local.type === "required" && (
                        <span>Local é um campo obrigatório</span>
                    )}
                    ...
                    {errors.startDate &&
                        errors.startDate.type === "required" && (
                            <span>Data de início é um campo obrigatório</span>
                        )}
                    ...
                    {errors.endDate && errors.endDate.type === "required" && (
                        <span>Data final é um campo obrigatório</span>
                    )}
