...
class AgriculturalInputTable extends Component {
    ...
    componentDidMount() {
        api.get("/api/agriculturalinputs/list")
            .then((res) => {
    ...
    async delete(id) {
        try {
            ...
            this.setState({
                message: "O insumo " + id + " foi excluído.",
            });
        } catch (err) {
            this.setState({
                error:
                    "Ocorreu o seguinte problema ao excluir o insumo " +
                    id +
                    ": " +
                    err,
            });
            ...
            <main>
                <div className="usertable__container">
                    ...
                    <table>
                        ...
                        <tbody>
                            {this.state.agriculturalinputs.map(
                                (agriculturalinput, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <Moment format="DD/MM/YYYY">
                                                {
                                                    agriculturalinput.acquisitionDate
                                                }
                                            </Moment>
                                        </td>
                                        <td>
